    ...
    <View style={styles.item}>
        ...
        <View style={{ alignItems: "center", justifyContent: "center" }}>
            ...
            <View style={styles.view}>
                <Text style={{ color: "#5baa5b", fontWeight: "bold" }}>Delivered</Text>
                <TouchableOpacity onPress={() => props.navigation.navigate(RoutesKey.OREDER_DELIVER)} style={{ backgroundColor: "#f3525c", borderRadius: 20, paddingHorizontal: 15, paddingVertical: 4, }}><Text style={{ color: "white", fontSize: 10 }}>Recorder</Text></TouchableOpacity>
        ...
        return (
            <SafeAreaView style={styles.container}>
                <SectionList
                    ...
                    renderItem={({ item }) => <Item data={item} props={this.props} />}
