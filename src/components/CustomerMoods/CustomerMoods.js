            ...
            <View style={StyleCus.item}>
                ...
                <View style={{ flex: 1, marginLeft: 4, paddingHorizontal: 5 }}>
                    ...
                    <View style={{ flex: 1, }}>
                        ...
                        <Text style={{ color: "#8a8a8a", fontSize: 14, paddingVertical: 3, }}>
                    ...
                    <View style={{ flex: 1, flexDirection: "row", paddingRight: 10, alignItems: "center", justifyContent: "space-between" }}>
                        ...
                        <TouchableOpacity>
                            <Icon name="heart" style={StyleCus.icon} />
                        </TouchableOpacity>
                    </View>
                </View>
        ...
        return (
            ...
            <ImageBackground
                ...
                <View style={StyleCus.main}>
                    <View>
                        <Text style={[StyleCus.sub, { fontSize: 16, fontWeight :"normal",fontFamily :"Poppins-SemiBold"}]}>HOW DO YOU FEEL NOW</Text>
                        <Text style={[StyleCus.p, { fontSize: 15, marginBottom: 10, marginTop: 3 }]}>Tell us we will find you something</Text>

                    </View>
                    <View style={[StyleCus.center, { marginBottom: 10 }]}>
                        <View>
                            ...
                            <View style={{ alignItems: "center", marginTop: 5 }}><Text style={{ fontSize: 10 }}>Happy</Text></View>
                        </View>
                        ...
                        <View>
                            ...
                            <View style={{ alignItems: "center", marginTop: 5 }}><Text style={{ fontSize: 10 }}>Hungry</Text></View>
                        ...
                        <View>
                            ...
                            <View style={{ alignItems: "center", marginTop: 5 }}><Text style={{ fontSize: 10 }}>Confuse</Text></View>
                        </View>
                        ...
                        <View>
                            ...
                            <View style={{ alignItems: "center", marginTop: 5 }}><Text style={{ fontSize: 10 }}>Sad</Text></View>
                    ...
                    <View style={[StyleCus.row, { padding: 5, alignSelf: "center" }]}>
                        <Text > Checkout our </Text>
                        <Text style={{ color: "#f3525c", fontWeight: "bold" }}>
                            HAPPY MEALS
                        </Text>
                        <Text > and </Text>
                        <Text style={{ color: "#f3525c", fontWeight: "bold" }}>
